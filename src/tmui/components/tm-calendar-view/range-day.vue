...
<template>
	<view class="flex flex-col relative">
		...
		<tm-button v-if="!props.hidnButton" :linear="props.linear" :linear-deep="props.linearDeep" :color="props.color" @click="confirm" block  label="确认" :margin="[32,16]"></tm-button>
