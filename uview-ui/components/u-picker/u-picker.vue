	...
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
		<view class="u-datetime-picker">
			...
			<view class="u-picker-body">
				<picker-view v-if="mode == 'region'" indicator-class="picker-box" :value="valueArr" @change="change" class="u-picker-view" mask-style="background: transparent;"  @pickstart="pickstart" @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'time'" indicator-class="picker-box" mask-style="background: transparent;" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart" @pickend="pickend">
...
::v-deep .picker-box{
	position: relative;
  width:100%;
  border-top:4rpx solid #151d31;
  border-bottom:4rpx solid #151d31;
  border-radius: 4rpx;
}
